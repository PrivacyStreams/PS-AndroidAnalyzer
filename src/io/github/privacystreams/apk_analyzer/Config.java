...
import io.github.privacystreams.apk_analyzer.utils.*;
...
public class Config {
    public static final String PROJECT_NAME = "PS-AndroidAnalyzer";
    ...
    public static boolean parseArgs(String[] args) {
        ...
        try {
            ...
            Config.dergFrontend = io.github.privacystreams.apk_analyzer.frontends.DERGFrontend.getBuilder(Config.frontendType);
            ...
            Config.dergBackend = io.github.privacystreams.apk_analyzer.backends.DERGBackend.get(Config.backendType);
